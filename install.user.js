...
// @version      1.4.0
// @description  ChatGPT / Gemini共通。横長画像の自動フィット、注意書き背景の透過、設定移行に対応した背景カスタマイズ統合版です。
...
// @require      https://raw.githubusercontent.com/uskmoo-blip/firemonkey-ai-background/main/display-fixes-patch.js?v=1.4.0
